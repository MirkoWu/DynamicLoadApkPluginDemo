...
public class MainActivity extends AppCompatActivity {
    ...
    public void jumpProxyActivity(View view) {
        startActivity(new Intent(getBaseContext(),ProxyActivity.class));
    }
    ...
    public void loadApk(View view) {
        ...
        for (final File file : files) {
            ...
            if (file.getName().endsWith(".apk")) {
                ...
                llList.addView(textView, new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, 80));
