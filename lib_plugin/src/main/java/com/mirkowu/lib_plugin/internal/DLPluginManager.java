...
import com.mirkowu.lib_plugin.DLBasePluginService;
import com.mirkowu.lib_plugin.DLProxyActivity;
import com.mirkowu.lib_plugin.DLProxyFragmentActivity;
import com.mirkowu.lib_plugin.DLProxyService;
import com.mirkowu.lib_plugin.utils.DLConstants;
import com.mirkowu.lib_plugin.utils.SoLibManager;
...
public class DLPluginManager {
    ...
    private void performStartActivityForResult(Context context, DLIntent dlIntent, int requestCode) {
        ...
        dlIntent.setFlags(DLIntent.FLAG_ACTIVITY_NEW_TASK);
